...
interface DHIS2IndexProps {
    config: Config;
    syncStats: SyncStats;
}

export default function Index({ config, syncStats }: DHIS2IndexProps) {
    const handleSync = async () => {
        if (confirm('Are you sure you want to sync data to DHIS2?')) {
    ...
    return (
        <AdminLayout header="DHIS2 Integration">
            <Head title="DHIS2 Integration" />

            {/* Header */}
            <div className="mb-6 rounded-xl border border-gray-200 bg-gradient-to-r from-blue-600 to-teal-600 p-6 text-white shadow-sm">
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        <Database className="h-12 w-12" />
                        <div>
                            <h2 className="text-2xl font-bold">DHIS2 Integration</h2>
                            <p className="text-blue-100">Health Information System Integration</p>
                        </div>
                    </div>
                    <Link href="/admin/dhis2/config" className="flex items-center gap-2 rounded-lg bg-white px-4 py-2 text-blue-600 hover:bg-blue-50">
            ...
            <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                    <button
                        ...
                        className="flex items-center justify-center gap-2 rounded-lg bg-blue-600 px-6 py-3 text-white hover:bg-blue-700 disabled:cursor-not-allowed disabled:opacity-50"
                    >
            ...
            <div className="mt-6 rounded-xl border border-blue-200 bg-blue-50 p-6">
                <h3 className="mb-2 text-lg font-semibold text-gray-900">About DHIS2 Integration</h3>
                <p className="text-gray-700">
                    DHIS2 (District Health Information System 2) integration allows automatic synchronization of health-related data entries,
                    indicators, and reports to the national health information system. Configure the integration settings to enable automatic data
                    synchronization.
                </p>
            </div>
        </AdminLayout>
