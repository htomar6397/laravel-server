                        ...
                        <tbody className="divide-y divide-gray-200 bg-white">
                            {logs.data.map((log) => (
                                <tr key={log.id} className="hover:bg-gray-50">
                                    ...
                                    <td className="max-w-xs truncate px-6 py-4 text-sm text-gray-500">{log.description || '-'}</td>
                ...
                {logs.data.length > 0 && (
                    <div className="flex items-center justify-between border-t border-gray-200 bg-white px-6 py-3">
                        <div className="text-sm text-gray-700">
                            Showing <span className="font-medium">{logs.meta.from}</span> to <span className="font-medium">{logs.meta.to}</span> of{' '}
